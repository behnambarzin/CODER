...
class RichUI:
            ...
            try:
                ...
                if not customized:
                    ...
                    if is_error:
                        ...
                        final_content = Align.center(Text("✓ COMPLETED", style="white"), vertical="middle")
    ...
    def startup_sequence(self):
        self._force_clear()
        welcome = Text("CODER v2.6", style="primary|bold")
        sub = Text("\nEstablishing secure connection...", style="dim")
        self.console.print(Align.center(welcome))
        self.console.print(Align.center(sub))
        time.sleep(2.0)
        self.console.clear()
    ...
    def node_llm(self, state: AgentState) -> Dict[str, Any]:
        with self.ui.node_context("LLM"):
            ...
            try:
                ...
                self.ui.log_thought(response.synthesis) # Log detailed thought below the box
    ...
    def node_reflect(self, state: AgentState) -> Dict[str, Any]:
        with self.ui.node_context("REFLECT"):
            ...
            reflection_prompt = (
                ...
                "Format: EXPERIENCE: [context] | ACTION: [done] | RESULT: [outcome] | LESSON: [takeaway]\n\n"
                f"MISSION HISTORY:\n{history_str}"
            )
    ...
    try:
        ...
        while True:
            ...
            if goal.strip():
                ...
                console.print(f"\n{Text('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━', style='dim')}")
                console.print(f"{Text('MISSION CYCLE CONCLUDED', style='primary|bold')}")
                console.print(f"{Text('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━', style='dim')}\n")

                # Strategic Menu
                console.print("[primary]COMMAND CENTER[/primary]")
                menu_options = [
                    ("1. [NEW MISSION]", "Wipe memory, keep model"),
                    ("2. [CONTINUE SESSION]", "Keep current context"),
                    ("3. [RECONFIGURE]", "Change model"),
                    ("0. [TERMINATE SYSTEM]", "Exit")
                ]
                for opt, desc in menu_options:
                    console.print(f"  {opt} {Text(f'({desc})', style='dim')}")
